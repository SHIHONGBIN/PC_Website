...
import NyAboutUs from './../components/subPage/nyAboutUs'
...
function IndexPage(data) {
  ...
  if(pageName=='关于我们'){
    aboutus = data?data.changenav.indexData.aboutus.aboutus:''
  }else if(pageName=='人才招聘'){
    aboutus = data?data.changenav.indexData.job:''
  }else{
    return false
  }
  return (
    <div className={styles.normal}>
      ...
      <div className={styles.nyWraper}>
        <Row>
          ...
          <Col span={18}>
          <NyAboutUs props = {navName} aboutus = {aboutus} />
          </Col>
          </Row>
      </div>
      <Footer />
